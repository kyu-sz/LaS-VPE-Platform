...
public class DeepMARTest {
    private final static String protocolPath = "models/DeepMAR/DeepMAR.prototxt";
    private final static String weightsPath = "models/DeepMAR/DeepMAR.caffemodel";
    ...
    @Before
    public void setUp() {
        recognizer = new DeepMAR(caffeGPU, protocolPath, weightsPath, logger);
